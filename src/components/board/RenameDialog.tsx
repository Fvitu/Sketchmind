...
export function RenameDialog({ currentName, isOpen, onClose, onRename }: RenameDialogProps) {
			...
			{isOpen && (
				<div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
					...
					<motion.div
						...
						<h2 className="mb-1 text-base font-semibold text-card-foreground">Rename Board</h2>
						<p className="mb-5 text-sm text-muted-foreground">Enter a new name for your board.</p>
